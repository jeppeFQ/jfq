...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // Select all collapsible ToC sections and force them open
    const tocSections = document.querySelectorAll(".toc .collapse");
    tocSections.forEach(section => {
      section.classList.add("show"); // Bootstrap uses 'show' to indicate expanded
    });
  });
</script>
