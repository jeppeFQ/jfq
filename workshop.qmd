...
## Segregation Indices {#segregation}
...
<style>
  ...
  main h2 .fa-arrow-right, main h2 .fa-arrow-down {
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    // Ensure Font Awesome icons are added as toggle indicators
    const sections = document.querySelectorAll("main h2");

    sections.forEach(section => {
      section.style.cursor = "pointer";

      // Add the initial icon (right arrow) to the header
      ...
      section.addEventListener("click", (event) => {
        ...
        // Update the icon
        icon.classList.toggle("fa-arrow-right", isVisible);
        icon.classList.toggle("fa-arrow-down", !isVisible);
      });
    });
  });
</script>
